...
class Runner:
    ...
    def summarize(self):
        ...
        self.writer.add_summary(tf.compat.v1.Summary(value=[tf.compat.v1.Summary.Value(tag='Epsilon per Episode', simple_value=self.agent.get_epsilon())]), self.episode)
